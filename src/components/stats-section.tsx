...
const LeaderboardDialog = ({ eventTitle }: { eventTitle: string }) => {
  ...
  const teamLogos: Record<string, string> = {
    ...
    "CYBERHACKS": "https://huggingface.co/Dat4W3rites/Cyber-Writeups-Data/resolve/main/morvax/ChatGPT%20Image%20Apr%2014%2C%202026%2C%2001_31_46%20AM.png",
  ...
  const loadLeaderboard = async () => {
    ...
    try {
      ...
      const scoreboard = [
        ...
        { team_name: "CYBERHACKS", points: "5262.000", rating: "25.165", pos: 10 },
  ...
  const handleRowClick = (teamName: string) => {
    if (teamName.toUpperCase() === 'CYBERHACKS') {
        ...
        <div className="flex-1 px-8 pb-10 pt-8">
          {loading ? (
            ...
            <div className="space-y-4">
              {results.map((team, i) => {
                const isCyberhacks = team.team_name?.toUpperCase() === 'CYBERHACKS';
                ...
                return (
                  <motion.div
                    ...
                    className={`flex items-center gap-6 px-6 py-5 border transition-all duration-300 group/row ${isCyberhacks
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className={`font-black tracking-tight font-mono ${isCyberhacks ? 'text-2xl text-white' : 'text-lg text-white/70'}`}>
                        {team.team_name}
                      </h4>
                    </div>

                    <div className="text-right flex flex-col items-end">
                      <span className={`font-black text-white font-mono ${isCyberhacks ? 'text-2xl' : 'text-lg'}`}>
